...
const FilterPopover = ({
    ...
    useLayoutEffect(() => {
        ...
        const numericWidth = typeof width === "number" ? width : parseInt(width as string, 10) || 320;

        // Prevent right overflow
        if (left + numericWidth > window.innerWidth) {
            left = window.innerWidth - numericWidth - 12;
        }
