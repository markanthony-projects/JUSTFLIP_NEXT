  ...
  const FeaturedProperty = ( {project, priority}: FeaturedPropertyProps) => {
    ...
    return (
      <>
      <article className='group relative w-full max-w-[400px] overflow-hidden rounded-xl bg-white border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_5px_20px_rgba(0,40,80,0.18)]'>
        ...
        <div className='px-5 py-3'>
          ...
          <Link href={projectUrl}>
              <h2 className="line-clamp-1 text-18px] font-extrabold leading-tight tracking-tight text-[#002B5B] transition-colors hover:text-[#00437A]" >
                  {projectName}
              </h2>
          </Link>
          ...
          <div className=" mt-3 border-t border-gray-200 pt-5 " >
            <div className=" flex items-end justify-between gap-4" >
              ...
              <div className="min-w-0">
                ...
                <p className=" mt-1 truncate text-[20px] font-extrabold leading-none text-[#002B5B] " >
                ...
                <Link href={projectUrl}
                  className=" flex shrink-0 items-center gap-1.5 rounded-xl bg-[#002B5B] px-4 py-2 text-xs font-bold text-white transition-all duration-200 hover:bg-[#003D7A] hover:shadow-lg ">
                      View Details<MdOutlineArrowForward size={18} />
                </Link>
