...
const emptySuggestions: SuggestionData = {
    projects: [],
    builders: [],
    locations: [],
};
...
const SearchBar = () => {
    ...
    const [suggestions, setSuggestions] = useState<SuggestionData>(emptySuggestions);
        ...
        >
            ...
            <div className="relative flex-1 flex items-center p-1">
                ...
                {hasSuggestions && (
                    ...
                    >
                        {flatSuggestions.map((item: any, index: number) => {
                            let label: string = "";
