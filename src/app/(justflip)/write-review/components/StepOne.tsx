...
//       id: p.id,
//       name: p.name,
//       icon: <PiBuildingApartment className="text-blue-500" />,
//     })),
//     ...(suggestions.locations || []).map((l) => ({
//       type: "location" as const,
//       id: l.id,
//       name: l.name,
//       icon: <SlLocationPin className="text-emerald-500" />,
//     })),
//   ];
...
//   const handleProceed = () => {
//     if (!selectedTarget || !userRole) return;
...
//             selectedTarget
//               ? "border-emerald-500 bg-emerald-50/20 focus:ring-2 focus:ring-emerald-500"
...
//           <div className="absolute top-full left-0 mt-1.5 w-full bg-white border border-gray-100 rounded-xl shadow-xl z-50 max-h-60 overflow-y-auto divide-y divide-gray-50">
//             {flatSuggestions.map((item) => (
//               <button
//                 key={`${item.type}-${item.id}`}
//                 type="button"
//                 onClick={() => handleSelectEntity(item)}
//                 className="w-full flex items-center justify-between px-4 py-3 text-xs hover:bg-gray-50 transition-colors text-left"
//               >
//                 <span className="font-medium text-gray-800 text-sm">{item.name}</span>
//                 <span className="flex items-center gap-1.5 text-gray-500 capitalize bg-gray-100 px-2.5 py-1 rounded-md text-[11px]">
//                   {item.icon} {item.type}
//                 </span>
//               </button>
//             ))}
...
//           className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm disabled:bg-gray-50 disabled:text-gray-400 transition-all"
//         />
//       </div>
...
//         className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-200 disabled:text-gray-400 text-white font-semibold rounded-xl transition-all shadow-sm"
//       >
//         Proceed to write review
//       </button>
//     </div>
//   );
// }
