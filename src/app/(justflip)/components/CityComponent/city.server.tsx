...
export const getCityPageData = cache(async (id: string | number) => {
  try {
...
export const getZonePageData = cache(async (id: string | number) => {
  if (!id) {
...
export const getLocationPageData = cache(async (id: string | number) => {
  try {
    const results = await Promise.allSettled([
...
export const getProjectPageData = unstable_cache(async (id: string | number) => {
  try {
...
export const getProjectReviews = cache(async (id: string | number) => {
  try {
...
export const getLocationDetails = cache(async (locationId: string | number) => {
...
export const getSimilarProjects = cache(async (locationId: string | number) => {
