    ...
    return (
        <div className="py-4 md:py-8 min-h-screen w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
                    ...
                    <div className="bg-white rounded-lg p-6 md:p-8 max-w-md w-full shadow-2xl space-y-6 border border-slate-100 relative overflow-hidden animate-modal">
                        ...
                        <div className="space-y-2 pt-2">
                            ...
                            <p className="text-sm font-medium text-slate-500 leading-relaxed">
                                You left off at <strong className="text-primary">Step {currentStep}: {STEP_TITLES[currentStep]?.title}</strong>. 
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-6 items-start" ref={dropdownRef}>
                ...
                {/* Main Form Container */}
                <div className="w-full lg:w-auto flex-1 bg-white rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col p-4 md:p-6 lg:p-8 gap-4 md:gap-6 lg:gap-8 relative overflow-hidden">
                    {/* Decorative Top Accent */}
                    <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-primary via-[#057748] to-primary" />
