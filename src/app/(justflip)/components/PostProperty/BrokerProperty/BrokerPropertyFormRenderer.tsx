...
import { inputClass, FieldDefinition } from './constants';
...
interface BrokerPropertyFormRendererProps {
...
const BrokerPropertyFormRenderer: React.FC<BrokerPropertyFormRendererProps> = ({
    fields = [],
    formData,
    errors,
    handleChange,
