...
export const inputClass: string =
    "w-full h-[48px] px-4 bg-slate-50 border border-slate-200 rounded-lg text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary hover:border-slate-300 transition-all shadow-sm";
 ...
 */
export const getInputFields = (type: string, cityOptions: Option[] = [], locations: Option[] = [], transactionType: string = ''): Record<number, FieldDefinition[]> => {
    const commonStep3: FieldDefinition[] = [
    ...
    const commonStep4: FieldDefinition[] = [
    ...
    const baseStep1: FieldDefinition[] = [
    ...
    const definitions: Record<string, Record<number, FieldDefinition[]>> = {
        apartment: {
            1: [
                ...baseStep1,
