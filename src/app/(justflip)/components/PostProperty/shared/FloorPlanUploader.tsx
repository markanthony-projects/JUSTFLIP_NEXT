...
interface UnitTypeComboboxProps {
    value: string;
    onChange: (val: string) => void;
}

function UnitTypeCombobox({ value, onChange }: UnitTypeComboboxProps) {
...
interface FloorPlanUploaderProps {
    ...
    onAltChange: (index: number, val: string) => void;
    onUnitChange: (index: number, val: string) => void;
    isUploading?: boolean;
}
