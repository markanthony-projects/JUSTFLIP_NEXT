...
const PublishPropertyStepper = ({ currentStep }: { currentStep: number }) => {
    ...
    return (
        <div className="relative w-full block">
            ...
            <div className="flex items-center justify-between text-[11px] lg:text-xs font-bold text-primary w-full px-1">
                {steps.map((step) => (
                    <span 
                        key={step.id} 
