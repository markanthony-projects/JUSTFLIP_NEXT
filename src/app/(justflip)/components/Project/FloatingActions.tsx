...
const ActionButton = ({ icon: Icon, onClick, label, bg = "bg-[#0B1C3D]", textColor = "text-white", hoverBg = "hover:bg-[#122a5c]", }: ActionButtonProps) => (
...
const FloatingActions = ({ data }: { data: Project }) => {
