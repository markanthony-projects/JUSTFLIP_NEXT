...
export default function ExploreMap({ project }: { project: Project }) {
    ...
    const [busStations, setBusStations] = useState<TransformedPlace[]>([]);
    const [airports, setAirports] = useState<TransformedPlace[]>([]);
    const [trainStations, setTrainStations] = useState<TransformedPlace[]>([]);
    const [hospitals, setHospitals] = useState<TransformedPlace[]>([]);
    const [schools, setSchools] = useState<TransformedPlace[]>([]);
    const [movieTheaters, setMovieTheaters] = useState<TransformedPlace[]>([]);
    const [shoppingMalls, setShoppingMalls] = useState<TransformedPlace[]>([]);
    const [superMarkets, setSuperMarkets] = useState<TransformedPlace[]>([]);
