...
export function ProjectAreaIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
...
export function SizesIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
        <svg className={className} viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M5.82764 11.1665H8.4943" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M5.82764 16.5H9.82764" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M5.82764 21.8335H8.4943" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11.1606 5.8335V8.50016" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M16.4941 5.8335V9.8335" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M21.8276 5.8335V8.50016" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}

export function TotalUnitsIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
        <svg className={className} viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M17.3335 9.8335V9.84683" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M22.6665 9.8335V9.84683" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M22.6665 15.1665V15.1798" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M22.6665 20.5V20.5133" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}

export function AvgPriceIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
        <svg className={className} viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
export function PossessionIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
        <svg className={className} viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M21.8276 4.5V9.83333" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11.1606 4.5V9.83333" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M5.82764 15.1665H19.161" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M24.4941 22.5V24.5L25.1608 25.1667" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}

export function ConfigurationsIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: IconProps) {
    return (
        <svg className={className} viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
