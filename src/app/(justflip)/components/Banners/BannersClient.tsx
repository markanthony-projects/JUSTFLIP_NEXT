...
function SlideImage({
    ...
    priority,
    visible
}: { banner: any, priority: boolean, visible: boolean }) {
    ...
    const mobileProps = banner?.meta?.mobileUrl ? getImageProps({ ...common, src: banner.meta.mobileUrl } as ImageProps) : null;
    const tabProps = banner?.meta?.tabUrl ? getImageProps({ ...common, src: banner.meta.tabUrl } as ImageProps) : null;
