...
export default function AutocompletePanel({ currentInput, onSelect }: AutocompletePanelProps) {
  ...
  const [suggestions, setSuggestions] = useState<{ projects: any[], locations: any[], builders: any[] } | null>(null);
      ...
      <div className="bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden max-h-[400px] overflow-y-auto">
        ...
        {suggestions.projects.length > 0 && (
          <div>
            ...
            <ul>
              {suggestions.projects.map((p: any) => (
        ...
        {suggestions.locations.length > 0 && (
          <div>
            ...
            <ul>
              {suggestions.locations.map((l: any) => (
        ...
        {suggestions.builders.length > 0 && (
          <div>
            ...
            <ul>
              {suggestions.builders.map((b: any) => (
