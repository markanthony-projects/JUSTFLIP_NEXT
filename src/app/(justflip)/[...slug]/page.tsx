...
export interface DynamicSeoSearchPageProps {
  params: Promise<{ slug?: string[] }>;
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

// Generate dynamic metadata
export async function generateMetadata({ params }: DynamicSeoSearchPageProps): Promise<Metadata> {
...
export default async function DynamicSeoSearchPage({ params, searchParams }: DynamicSeoSearchPageProps) {
  const p = await params;
