...
const BrokerProfile = () => {
    ...
    return (
        <div className='mb-10 min-h-screen'>
            ...
            >
                <div className='mb-6'><Breadcrumb items={[{ label: 'Broker Profile' }]} /></div>
            </motion.div>
            ...
            <div className='flex flex-col gap-8 mt-6 max-w-6xl mx-auto'>
                ...
                >
                    ...
                    {activeNav === 'security' && (
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className='bg-white/70 backdrop-blur-xl rounded-lg p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50 text-center'>
                            ...
                            <button onClick={() => setIsPasswordModalOpen(true)} className="px-6 py-2.5 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all shadow-sm shadow-blue-500/20">
                                Change Password
                            </button>
                        </motion.div>
                    )}
                    ...
                    {activeNav === 'notifications' && (
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className='bg-white/70 backdrop-blur-xl rounded-lg p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50 text-center'>
