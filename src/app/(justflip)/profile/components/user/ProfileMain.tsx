...
const ProfileMain = () => {
  ...
  const [modalMode, setModalMode] = useState<'all' | 'both' | null>(null)
  ...
  const validateAll = () => {
    const fields = modalMode ? fieldsArray[modalMode] : []
    // console.log(fields)
  ...
  return (
    <div className='mb-10 min-h-screen'>
      ...
      >
        <div className='mb-6'><Breadcrumb items={[{ label: 'Profile' }]} /></div>
      </motion.div>
          ...
          <Modal isOpen={!!modalMode} onClose={closeModal}>
            ...
            >
              ...
              <div className="space-y-4">
                {(modalMode ? fieldsArray[modalMode] : []).map(({ key, label, type }) => (
