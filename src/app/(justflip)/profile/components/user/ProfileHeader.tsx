...
const ProfileHeader = ({ onEditClick }: { onEditClick: () => void }) => {
      ...
      <div className='hidden md:block px-8 pb-8'>
        <div className='flex flex-row items-end justify-between gap-6'>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onEditClick}
            className="shrink-0 flex items-center gap-2 bg-white border border-gray-200 text-gray-700 text-sm font-semibold px-5 py-2.5 rounded-lg hover:bg-gray-50 hover:text-blue-600 hover:border-blue-200 transition-all shadow-sm"
          >
            <MdEdit size={16} />
