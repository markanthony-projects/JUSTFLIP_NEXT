                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-xs sm:text-sm">
                                Instantly calculate your monthly home loan EMI
                            </p>
                        </div>
                    </div>
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="colorInterest" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="0%" stopColor={
                                                Number(interestRate) <= 5 ? "#22c55e" : Number(interestRate) <= 12 ? "#f59e0b" : "#ef4444"
                                            } />
                                            <stop offset="100%" stopColor={
                                                Number(interestRate) <= 5 ? "#16a34a" : Number(interestRate) <= 12 ? "#ea580c" : "#b91c1c"
                                            } />
                                        </linearGradient>
                                    </defs>
                                    <Pie
