  ...
  return(
    <div ref={dropDownRef} className='relative w-full'>
      ...
      <button type="button"
        ...
        <span className={`text-[12px] selectedOption? 'text-primary' : 'text-gray-300' `}>
        ...
        <div className='overflow-hidden rounded-lg border-2 border-[#e1e8f2] bg-white shadow-[0_20px_60px_rgba(0,43,91,0.10)]'>
          ...
          <div className='flex items-center justify-between border-b border-[#e8edf4] px-5 py-4 md:px-7'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <div>
                <h2 className='text-base font-bold text-primary md:text-md uppercase'>
          ...
          <div className='space-y-6 px-5 py-4 md:px-7 md:space-y-4'>
                    ...
                    className={`rounded-lg py-2 text-sm font-semibold transition-all duration-200
                      ${
                          category === item.value
                              ...
                              : ` text-[#66758b] hover:text-primary`
                      }`}
                  >
                    {item.label}
                  </button>
              ...
              <div className='flex items-center overflow-hidden rounded-lg border border-[#d9e2ef] bg-white transition-all 
                duration-200 focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10'>
                  <input
                    ...
                    placeholder="0.00"
                    className='min-w-0 flex-1 bg-transparent px-5 py-2 text-lg font-semibold tracking-tight text-primary outline-none placeholder:text-[#b9c4d3] md:text-xl'
                  />
            ...
            <button type="button"
              ...
              disabled={!inputValue}
              className='group flex w-full items-center justify-center gap-3 rounded-lg bg-primary px-5 py-3 text-base font-bold text-white shadow-[0_8px_20px_rgba(0,43,91,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#003b7c] hover:shadow-[0_12px_25px_rgba(0,43,91,0.22)] active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:translate-y-0 md:py-3'
            >
              <span> Convert </span>
