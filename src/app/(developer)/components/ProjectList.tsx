                ...
                renderItem={(project: any, i: number) => {
                    ...
                    return (
                        <Link href={projectUrl} key={project?.id} className="block group w-[280px] lg:w-[310px]">
                            <div className="bg-white border border-gray-100 rounded-lg overflow-hidden shadow-sm hover:-translate-y-1 transition-all duration-300 p-2.5 h-[90px] flex items-center justify-between">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                    <div
                                        className="h-[70px] w-[70px] shrink-0 bg-cover bg-center rounded-lg group-hover:scale-105 transition-transform duration-500"
                                        style={{
                                    ...
                                    <div className="flex flex-col justify-center flex-1 overflow-hidden min-w-0">
                                        <h3 className="text-sm font-bold text-primary truncate mb-0.5" title={project?.name}>
                                            {project?.name}
                                        </h3>
                                ...
                                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-colors text-primary ml-2">
