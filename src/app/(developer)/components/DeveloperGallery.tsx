...
const CinematicCard = ({ emp, index, activeIndex, setActiveIndex }: CinematicCardProps) => {
...
export interface DeveloperGalleryProps {
  builder?: any[];
}

const DeveloperGallery = ({ builder = [] }: DeveloperGalleryProps) => {
