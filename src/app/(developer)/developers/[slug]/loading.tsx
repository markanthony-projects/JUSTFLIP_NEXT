    ...
    <div className='bg-[#F4F9FA] min-h-screen pb-20'>
      ...
      <div className="w-full h-[60vh] md:h-[70vh] relative flex flex-col justify-end">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="h-full w-full bg-gradient-to-br from-primary to-slate-800 animate-pulse" />
        ...
        <div className="relative z-10 w-full px-2 md:px-8 lg:px-24 mx-auto -mt-14 sm:-mt-16 md:-mt-20">
          <div className="bg-white border border-gray-200/80 rounded-lg md:rounded-lg shadow-lg p-5 sm:p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-5 md:gap-8">
            {/* Logo Container */}
            <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 shrink-0 bg-white rounded-lg p-2.5 border border-gray-200 shadow-md overflow-hidden flex items-center justify-center">
              <SkeletonBlock className="w-full h-full rounded-lg bg-gray-200 animate-pulse" />
            </div>
      ...
      <div className="w-full mx-auto px-2 md:px-8 lg:px-24 pt-8 md:pt-12 space-y-8 md:space-y-12">
        ...
        <section>
          ...
          <div className="flex gap-4 md:gap-6 overflow-hidden py-4 px-2 -mx-2">
            {[1, 2, 3, 4].map((i) => (
              <SkeletonBlock
                key={i}
                className="shrink-0 w-[240px] md:w-[280px] h-[320px] md:h-[380px] rounded-lg bg-gray-200 animate-pulse"
              />
            ))}
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-white rounded-lg p-4 md:p-6 shadow-xl border border-gray-100">
            <SkeletonBlock className="w-full h-[400px] rounded-lg bg-gray-200 animate-pulse" />
          </div>
        </section>
