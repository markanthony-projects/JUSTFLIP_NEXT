...
const ReviewModal = ({ formData, isOpen, onClose, onSubmit, error }: ReviewModalProps) => {
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    ...
                    <div>
                        ...
                        <div className="text-xs space-y-2">
                            <p><span className="text-gray-500">Expertise:</span> {formData.expertiesIn?.filter((e: any) => e).join(", ") || "None"}</p>
