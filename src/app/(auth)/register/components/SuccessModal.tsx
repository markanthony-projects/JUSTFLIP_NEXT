...
export default function SuccessModal({ isOpen }: SuccessModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center app-overlay p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-sm w-full p-8 text-center animate-modal">
        ...
        <button
          ...
          className="w-full bg-[#0B8019] text-white py-3 px-4 rounded-lg font-semibold text-lg hover:bg-green-700 transition shadow-lg shadow-green-200"
        >
          Go to My Profile
        </button>
      </div>
