...
export const convertToCurrency = (price: number | string | null | undefined, currency: string = "INR"): string => {
...
export const getLowestAndHighestPrice = (units: any[] = []): { minPrice: number; maxPrice: number } => {
...
export const getDefaultCurrencyFromUnits = (units: any[] = [], fallback: string = "INR"): string => {
...
export const formatDisplayPrice = (price: number | string | null | undefined, currency: string = "INR"): string => {
